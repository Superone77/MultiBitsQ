...
# Format random init flag (True -> rinit, False -> no_rinit)
...
# Generate EXP_NAME
EXP_NAME="${MODEL_NAME}_${BIT_STR}bit_${STEPS_STR}_bs${TOTAL_BS}_${LR_STR}_rap${RAP_STR}_prob${PROB_STR}_${RINIT_STR}_${DATE_STR}"
